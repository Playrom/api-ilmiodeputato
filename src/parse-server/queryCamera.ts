export function getTuttePersone () {
...
export function getAdesioniGruppo () {
  return `prefix dcterms: <http://purl.org/dc/terms/>
...
export function getIncarichiGruppo () {
  return `prefix dcterms: <http://purl.org/dc/terms/>
...
export function getUfficiParlamentari () {
  return `prefix dcterms: <http://purl.org/dc/terms/>
...
export function getCommissioni () {
  return `prefix dcterms: <http://purl.org/dc/terms/>
...
export function getComponentiMisto () {
  return `prefix dcterms: <http://purl.org/dc/terms/>
...
export function getPrimiFirmatari () {
  return `prefix dcterms: <http://purl.org/dc/terms/>
...
export function getAltriFirmatari () {
  return `prefix dcterms: <http://purl.org/dc/terms/>
  SELECT DISTINCT ?atto ?deputato ?persona ?ruolo ?type
  WHERE {
    ?atto ocd:rif_leg <http://dati.camera.it/ocd/legislatura.rdf/repubblica_18>;
...
export function getLeggiDeputato (personaUrl: String , isPrimoFirmatario: Boolean, limit: Number, offset: Number) {
  let paging = ''
...
export function getNumeroLeggiDeputato (personaUrl: String, isPrimoFirmatario: Boolean) {
...
export function getDataLegge (numeroLegge: Number) {
...
export function getFirmatariLegge (numeroLegge: Number) {
...
export function getVotazioniLegge (numeroLegge: Number, limit: Number, offset: Number) {
  let paging = ''
  if (limit !== undefined && offset !== undefined) {
    paging = `LIMIT ${limit} OFFSET ${offset}`
  }
...
export function getNumeroVotazioniLegge (numeroLegge: Number) {
...
export function getVotazione (numeroVotazione: Number) {
...
export function getVotiDeputatiVotazione (numeroVotazione: Number) {
  const votazione = `${numeroVotazione.toString().substr(0,3)} ${numeroVotazione.toString().substr(3,6)}`
